...
const OrderCart = ({ category, setCategory, orderId }) => {
  ...
  const updateOrder = async () => {
    ...
    try {
      const response = await fetch(`https://johannas-grille.onrender.com/api/orders/${orderId}`, {
        method: 'PUT',
  ...
  const handleRemoveItem = async (itemId) => {
    try {
      const response = await fetch(`https://johannas-grille.onrender.com/api/orderitems/${itemId}`, {
        method: 'DELETE',
      });
