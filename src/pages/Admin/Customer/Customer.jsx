...
const CustomerList = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://johannasgrille.onrender.com/api/menuitems'); // Adjust this to your API URL
  ...
  const fetchCustomer = () => {
    fetch("https://johannasgrille.onrender.com/api/customer")
